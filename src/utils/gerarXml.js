...
module.exports = {
  XMLSTATUS(
    ...
    // monta xml
    const doc = create()
      .ele(ns1, "soapenv:Envelope")
      .att({ "xmlns:ans": ansSchema, "xmlns:xd": sch })
      .ele(ns1, "Header")
      .up()
      .ele(ns1, "Body")
      ...
      .txt(dataToXml.seq)
      .up()
      .ele("dataRegistroTransacao")
      .txt(dataToXml.date)
      .up()
      .ele("horaRegistroTransacao")
      .txt(dataToXml.time)
      .up()
      .up()
      .ele("origem")
      ...
      .txt(dataToXml.numGuia)
      .up()
      .up()
      .ele("dadosBeneficiario")
      .ele("numeroCarteira")
      .txt(dataToXml.matricula)
      .up()
      .ele("atendimentoRN")
      .txt(dataToXml.rn)
      .up()
      .ele("nomeBeneficiario")
      .txt(dataToXml.nomeBeneficiario)
      .up()
      .up()
      .ele("dadosContratado")
      .ele("codigoPrestadorNaOperadora")
      .txt(dataToXml.codigoOpe2)
      .up()
      .ele("nomeContratado")
      .txt(dataToXml.nomeContratado)
      .up()
      .up()
      .up()
      .ele("hash")
